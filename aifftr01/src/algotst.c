...
*  and 'imagData'.  Each time this function is called, the next input values 
*  are pulled from the table in RAM.  The table wraps around, so that input
*  data is continuous. A flag is returned TRUE whenever the table wraps around.
*
*/    
