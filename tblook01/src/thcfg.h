...
#define EEMBC_PROCESSOR        "ARMR5"
#define EEMBC_TARGET           "STANDALONE"
...
#define	WINDOWS_EXAMPLE_CODE	(FALSE)
...
#define COMPILE_OUT_HEAP (FALSE)
#endif

#if !defined (HAVE_MALLOC_H)
#define HAVE_MALLOC_H (FALSE)
#endif
