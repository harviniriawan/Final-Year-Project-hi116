...
#include <string.h>
#include <ctype.h>
#include <xtime_l.h>  /*processor specific time library, defined in BSP*/
...
static XTime  start_time;
static XTime  stop_time;
...
{
	/* clock frequency of the board*/
	return (size_t) COUNTS_PER_SECOND;
}
