 ...
 *          $Author: rick $
 *          $Source: d:/cvs/eembc2/automotive/rspeed01/algotst.c,v $
 *          
 * NOTE   :
 *
 *------------------------------------------------------------------------------
...
*
*    Builds the table of input data which represents 'tonewheelCounter'
...
*
*    On each pass of the table lookup, a value must be input for 'tonewheelCounter'.
