...
{
xil_printf( ">>------------------------------------------------------------\n" );
xil_printf( ">> EEMBC Component          : %s\n",EEMBC_TH_ID);
xil_printf( ">> EEMBC Member Company     : %s\n",tcdef->member);
xil_printf( ">> Target Processor         : %s\n",tcdef->processor);
xil_printf( ">> Target Platform          : %s\n",tcdef->platform);
xil_printf( ">> Target Timer Available   : %s\n",th_timer_available() ? "YES"   : "NO" );
xil_printf( ">> Target Timer Intrusive   : %s\n",th_timer_is_intrusive() ? "YES" : "NO" );
xil_printf( ">> Target Timer Rate        : %d\n",th_ticks_per_sec());
xil_printf( ">> Target Timer Granularity : %d\n",th_tick_granularity());
#if		CRC_CHECK
xil_printf( ">> Required Iterations      : %d\n",tcdef->rec_iterations);
#else
xil_printf( ">> Recommended Iterations   : %d\n",tcdef->rec_iterations);
#endif
if (tcdef->iterations != tcdef->rec_iterations)
xil_printf( ">> Programmed Iterations    : %d\n", tcdef->iterations );
xil_printf( ">> Bench Mark               : %s\n",tcdef->desc);
}
